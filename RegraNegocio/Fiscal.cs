    ...
    public class Fiscal
    {
        ...
        public static void Analisa_iRetorno(int IRetorno)
        {
            ...
            switch (IRetorno)
            {
                ...
                case -23:
                    mensagem = "Não foi possível terminar a Operação!";
                    break;
                ...
                case -25:
                    mensagem = "Totalizador não fiscal não programado.";
                    break;

                case -26:
                    mensagem = "Transação já Efetuada!";
                    break;

                case -27:
                    Analisa_RetornoImpressora();
                    break;

                case -28:
                    mensagem = "Não há Informações para serem Impressas!";
                    break;
            }
